...
let virtual-env = "F:\workspace-cursos\devmedia\python\CalculadoraCombustivel"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "F:\workspace-cursos\devmedia\python\CalculadoraCombustivel\Scripts\deactivate.nu"
