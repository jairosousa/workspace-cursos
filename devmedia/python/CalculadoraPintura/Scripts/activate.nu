...
let virtual-env = "F:\workspace-cursos\devmedia\python\CalculadoraPintura"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "F:\workspace-cursos\devmedia\python\CalculadoraPintura\Scripts\deactivate.nu"
